...
static func _static_init() -> void:
	...
	LEVELS.append(_make("机制试炼场", 0,
		...
		[
			...
			Rect2(4900, 1300, 400, 120),         # 天花板甲板一(底面 = 逆的天路)
			{"rect": Rect2(5500, 1300, 400, 120), "note": "E5"},     # 天花甲板二(底面琴键:高音对答)
			Rect2(6100, 1300, 400, 120),         # 天花甲板三
			...
			{"rect": Rect2(13300, 1300, 500, 120)},                  # 上层天路(界走上面)
			{"rect": Rect2(13450, 1710, 100, 90), "who": [4]},       # 双子阶梯 1(唯双子可踏)
			{"rect": Rect2(13550, 1620, 100, 180), "who": [4]},      # 双子阶梯 2
			{"rect": Rect2(13650, 1530, 100, 270), "who": [4]},      # 双子阶梯 3
			# —— Z5 归门台 ——
		...
		[   # hints
			{"pos": Vector2(430, 1330), "text": "机制试炼场 v2:双平台置换与双子双平台,逐区自检"},
			...
			{"pos": Vector2(13400, 1050), "text": "双子双平台:界上天路,边走地面,磁界斜封通道"},
			{"pos": Vector2(13900, 1150), "text": "磁界只放行逆:其余几何体请双子移位让路"},
		],
	))
