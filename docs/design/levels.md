...
| R12 | **过渡件·端头截面 16**:变厚·薄↔整×2 / 凸节点·凹节点 / 半高↔全高×2 / **削角 45° 墙柱×4**(左上·右上·左下·右下,防挂角)/ 材质交界×4(石↔亮对角、石↔墨竖分、亮↔动竖分、动↔石对角)/ 柱头·柱脚(T 形双多边形) | 端头 = 分段多边形;削角 = 五边形;材质 = 整方;柱 = 双多边形 |
| R13 | **过渡件·跑平桥接 16**:坡脚跑平×2(45° 坡后垫平)/ 双层桥·薄对薄×1(双单向)/ 薄对厚×1 / 天桥·厚对薄×1(天花)/ 双层天花×1 / 踢脚·顶裙 / 腰线 / 分层上亮下暗·上暗下亮 / 女儿墙 / 檐口 / 嵌筋横·竖 / 百叶过渡带 | 跑平 = 五边形;桥 = 单向/天花单向组合;其余整方 |
