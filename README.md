...
**正戏五幕 26 场全量在演**(2026-09-14):第一幕「各自的路上」/ 第二幕「界与边」
/ 第三幕「分岔」/ 第四幕「蜕变」/ 第五幕「刻度的真相」;
+ **肉鸽模式「重跑 RE-RUN」**(四位主角各一条三章节目链)。

当前版本 **v0.44.0**(唯一来源 `scripts/core/version.gd`,变更明细见 [CHANGELOG.md](CHANGELOG.md))。
...
- **剧目 REPERTOIRE**:正戏五幕 26 场——第一幕「各自的路上」六场(疾速 /
  弹阶 / 对面 / 坡道 / 双生阶 / 合演)+ 第二幕「界与边」六场(伍入队)+
  第三幕「分岔」五场(四单章正剧化)+ 第四幕「蜕变」五场(疾学会停 /
  跃为自己折 / 逆落地 / 圆回头)+ 第五幕「刻度的真相」四场(落幕五门归位)。
  测试道(机制试炼场 / 伍试水)已清退;通关自动切下一场,终关接尾声。
