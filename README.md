...
当前版本 **v0.15.0**(唯一来源 `scripts/core/version.gd`,变更明细见 [CHANGELOG.md](CHANGELOG.md))。

## 当前内容

- **剧目 REPERTOIRE**:序章剧目「六场连演」(疾 / 跃 / 逆 / 圆 四场单演 +
  机关·合拍 动态构件课 + 合演·四人同行 终场)+ 第一幕「引力排练」
  **六场巨构全部开演**(巨构门厅 / 承接天桥 / 双面回廊 / 速度圣殿 / 碎裂穹顶 /
  幕间·大风琴;四角色分位出生/分位归门;v0.15 逐几何体层级 `lanes` 全关数据化——
  受控几何体的主场实色、他人路线巨构退为背景);第二、三幕(碎裂舞台 / 终局构成)待开演。
...
- **机制**:二段跳、踩头承载与超载减半、重力置换(逆)、纯滚动与曲面板切线飞跃(圆)、
  ...
  动态构件(限时桥 / 开关门——一门多开关的气闸式互让,序章 05 首用)。
- **剧情**:Konado 驱动的序幕(七拍)、第一幕开演剧、重跑序说与
  四位主角的个人单章刻画、尾声;「档案几何 → 回廊」页签以**全文本阅读器**回看
  (台词按角色着色、按分拍分段,不重播对话)。
